...
const immersiveFilms = [
    ...
    { id: 'film-5', title: 'Underwater Lagos', image: 'https://checkyeti.imgix.net/images/prod/products/26607/try-scuba-diving-in-lagos-for-beginners-with-we-dive-lagos-hero-image?auto=format,compress&fit=crop&format=jpeg&jpeg-progressive=true&fit=crop&w=846&h=436&dpr=1', description: 'A speculative documentary showing the lost wonders hidden beneath the Lagos Lagoon.' },
];
