...
const immersiveFilms = [
    { id: 'film-1', title: 'A Day in Makoko', image: 'https://images.unsplash.com/photo-1599422434057-a3f29056c522?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'A 360-degree documentary that puts you in the heart of the vibrant floating community of Makoko, Lagos.' },
    { id: 'film-2', title: 'Spirit of the Serpent', image: 'https://images.unsplash.com/photo-1615692576534-026c045888e2?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'An animated folk tale that unfolds around you, bringing ancient myths to life in a visually stunning world.' },
    { id: 'film-3', title: 'Jos: The Origin', image: 'https://images.unsplash.com/photo-1600244198818-283f42d826a7?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'Explore the breathtaking landscapes of Jos Plateau in this cinematic VR experience.' },
    { id: 'film-4', title: 'Afro-Futurist Dream', image: 'https://images.unsplash.com/photo-1679579493221-a065f417f7d9?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'A sci-fi short film that imagines Lagos in 2077. Fly through a city of towering wonders and technological marvels.' },
    { id: 'film-5', title: 'Underwater Lagos', image: 'https://images.unsplash.com/photo-1582210334863-31b67a14a3dd?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'A speculative documentary showing the lost wonders hidden beneath the Lagos Lagoon.' },
];
...
const interactiveMusic = [
    ...
    { id: 'music-2', title: 'The Cavemen: Forest Session', image: 'https://images.unsplash.com/photo-1471478293233-f8a652a67e43?q=80&w=2073&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'An intimate, volumetric performance in a lush, virtual forest. Walk around the band as they play.' },
    { id: 'music-3', title: 'Rema\'s Rave Galaxy', image: 'https://images.unsplash.com/photo-1587213813886-45598b3c375d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'A rhythm game set in a vibrant alien world, featuring the biggest tracks from Rema.' },
    { id: 'music-4', title: 'Sounds of the Market', image: 'https://images.unsplash.com/photo-1543088242-219755913255?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'An ambient soundscape experience. Isolate and explore the unique sounds of Balogun Market.' },
    { id: 'music-5', title: 'Highlife VR', image: 'https://images.unsplash.com/photo-1583013271584-7a1a24250485?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'Travel back to a 1960s ballroom and enjoy a classic highlife band performance.' },
];

const vrArcade = [
    { id: 'game-1', title: 'Danfo Racer VR', image: 'https://images.unsplash.com/photo-1551733644-b04aaa759a2f?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'Navigate the chaotic streets of Lagos in this thrilling and hilarious VR racing game.' },
    { id: 'game-2', title: 'Oduduwa\'s Challenge', image: 'https://images.unsplash.com/photo-1534430480872-7b641163e45a?q=80&w=1956&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'A puzzle-adventure game based on Yoruba mythology. Solve ancient riddles to gain mythical powers.' },
    { id: 'game-3', title: 'Sokoto Skies', image: 'https://images.unsplash.com/photo-1519734132338-b3d16e043642?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'A serene hot air balloon exploration game over the beautiful landscapes of northern Nigeria.' },
    { id: 'game-4', title: 'Market Mayhem', image: 'https://images.unsplash.com/photo-1600577372881-333342d38555?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'A fun, fast-paced game where you manage a busy market stall, serving customers and haggling prices.' },
    { id: 'game-5', title: 'Aso-Oke Weaver', image: 'https://images.unsplash.com/photo-1622979213568-1514a3773173?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'A relaxing simulation game where you learn the traditional art of Aso-Oke weaving with haptic feedback.' },
];
